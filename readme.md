...
<a id='snippet-tocBefore.txt-/docs/mdsource/toc/tocBefore.txt'></a>
```txt
# Title
...
Text2
```
<sup>[snippet source](/docs/mdsource/toc/tocBefore.txt#L1-L11) / [anchor](#snippet-tocBefore.txt-/docs/mdsource/toc/tocBefore.txt)</sup>
<!-- endsnippet -->

The result will be rendered:

<!-- snippet: tocAfter.txt -->
<a id='snippet-tocAfter.txt-/docs/mdsource/toc/tocAfter.txt'></a>
```txt
# Title
...
Text2
```
<sup>[snippet source](/docs/mdsource/toc/tocAfter.txt#L1-L16) / [anchor](#snippet-tocAfter.txt-/docs/mdsource/toc/tocAfter.txt)</sup>
<!-- endsnippet -->
...
<a id='snippet-HeaderWriterTests.DefaultHeader.approved.txt-/src/Tests/HeaderWriterTests.DefaultHeader.approved.txt'></a>
```txt
GENERATED FILE - DO NOT EDIT
This file was generated by [MarkdownSnippets](https://github.com/SimonCropp/MarkdownSnippets).
...
To change this file edit the source file and then run MarkdownSnippets.
```
<sup>[snippet source](/src/Tests/HeaderWriterTests.DefaultHeader.approved.txt#L1-L4) / [anchor](#snippet-HeaderWriterTests.DefaultHeader.approved.txt-/src/Tests/HeaderWriterTests.DefaultHeader.approved.txt)</sup>
<!-- endsnippet -->
...
<a id='snippet-LinkFormat.cs-/src/MarkdownSnippets/Processing/LinkFormat.cs'></a>
```cs
...
```
<sup>[snippet source](/src/MarkdownSnippets/Processing/LinkFormat.cs#L1-L8) / [anchor](#snippet-LinkFormat.cs-/src/MarkdownSnippets/Processing/LinkFormat.cs)</sup>
<!-- endsnippet -->

<!-- snippet: BuildLink -->
<a id='snippet-buildlink-/src/MarkdownSnippets/Processing/SnippetMarkdownHandling.cs'></a>
```cs
...
```
<sup>[snippet source](/src/MarkdownSnippets/Processing/SnippetMarkdownHandling.cs#L64-L73) / [anchor](#snippet-buildlink-/src/MarkdownSnippets/Processing/SnippetMarkdownHandling.cs)</sup>
<!-- endsnippet -->
